...
项目的目标，是把《英雄没有闪》这类产品中“自动战斗 + 刷图掉落 + 构筑成长 + 离线收益”的核心循环拆出来、重做出来，并逐步收敛成一个可在线试玩、可持续迭代的独立项目。
...
`AFK-RPG` 是一个以“挂机刷图”为核心的横版 ARPG 原型，强调：

- 自动战斗也要有清晰反馈，而不是纯数值滚动
- 掉落不只是产出，还要有足够明确的视觉回报
- 中期驱动力来自装备、词条、传奇目标与研究成长的叠加
- UI 不只是信息堆叠，而要服务于“看懂战斗、看懂构筑、看懂收益”

如果用一句话概括当前版本：

> 这是一个正在被持续打磨的“可试玩挂机刷宝战斗舞台”。
